...
decisions.md. Status: EXECUTED (9 gold observations, 6 changed / 3 unchanged, 10-K + history
pack, probes + paired A/B, Opus 4.5); metered $5.21 - see results.md. Files: selection.json (the
