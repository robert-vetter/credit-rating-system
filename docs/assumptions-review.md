...
| 10 | Retail and Apparel covers 150-250 Moody's issuers | **measured** (notes/rating-history-file.md): 164 SEC-filing issuers in the sector frame, 86 actively rated as of Aug 2025 (31 IG, 55 spec). Sample arithmetic: a few hundred samples requires issuer-dates or added sectors | Was the basis for sample-size hopes; now a fact |
